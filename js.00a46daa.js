...
var initHeader = function initHeader() {
  var navSlide = function navSlide() {
    var burger = document.querySelector('.header__mobile-menu');
    var nav = document.querySelector('.header__menu');
    var navLinks = document.querySelectorAll('.hader__nav li');
    ...
    function closeMenu() {
      ...
      burger.classList.remove('toggle'); // body.classList.remove('lock')
    }
  };
...
},{"swiper":"../node_modules/swiper/swiper.esm.js"}],"js/_helpers.js":[function(require,module,exports) {
"use strict";
...
var initPopup = function initPopup() {
  var popupLinks = document.querySelectorAll('.popup-links');
  ...
  if (popupCloseIcon.length > 0) {
    var _loop2 = function _loop2(_index) {
      ...
      el.addEventListener('click', function (e) {
        ...
        document.querySelectorAll('input,textarea,.label-file').forEach(function (item) {
          item.style.borderWidth = '1px';
          item.classList.remove('error'); // document.querySelector('.checkbox-box>label').classList.remove('error');
...
},{"./_helpers":"js/_helpers.js"}],"../node_modules/aos/dist/aos.js":[function(require,module,exports) {
var define;
...
},{"aos":"../node_modules/aos/dist/aos.js","aos/src/js/aos":"../node_modules/aos/src/js/aos.js"}],"js/_projects.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initProjects = void 0;

var initProjects = function initProjects() {
  var toggleFolder = document.getElementById("js_toggle-folder"); // --------- ANIMATION

  var showFolderContentAnimation = anime.timeline({
    easing: "easeOutCubic",
    autoplay: false
  });
  showFolderContentAnimation.add({
  ...
  toggleFolder.addEventListener("click", function () {
    if (showFolderContentAnimation.began) {
      ...
      if (showFolderContentAnimation.progress === 100 && showFolderContentAnimation.direction === "reverse") {
...
var _skills = require("./_skills");

var _projects = require("./_projects");
...
(function () {
  ...
  try {
    ...
    (0, _swiper.initSwiper)(); // initForms();

    (0, _popup.initPopup)();
    (0, _skills.initSkills)();
    (0, _projects.initProjects)();
  } catch (err) {
    console.log(err);
  }
})();
},{"./_header":"js/_header.js","./_swiper":"js/_swiper.js","./_popup":"js/_popup.js","./_skills":"js/_skills.js","./_projects":"js/_projects.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
